        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 sm:p-10 space-y-8">
          ...
          <div className="border-b border-slate-200 pb-6">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mb-2">
              {t('usagePolicy.headerTitle')}
            </h2>
            <p className="text-xs sm:text-sm text-slate-500">
              {t('usagePolicy.effectiveDate', { date: 'August 2026' })} • {t('usagePolicy.subtitle')}
            </p>
          </div>
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              ...
              {t('usagePolicy.s1Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              {t('usagePolicy.s1Body')}
            </p>
          </section>

          {/* Section 2: Prohibited Conduct & System Abuse (Highlighted) */}
          <section className="space-y-4 rounded-xl bg-amber-50/60 border border-amber-200/80 p-5">
            <h3 className="text-lg font-bold text-amber-950 flex items-center gap-2">
              <span className="w-6 h-6 rounded-lg bg-amber-200/80 text-amber-900 flex items-center justify-center text-xs font-black">2</span>
              {t('usagePolicy.s2Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed font-medium">
              {t('usagePolicy.s2Intro')}
            </p>
            <ul className="list-disc list-outside ml-6 space-y-2 text-xs sm:text-sm text-slate-700 leading-relaxed">
              <li>{t('usagePolicy.s2Item1')}</li>
              <li>{t('usagePolicy.s2Item2')}</li>
              <li>{t('usagePolicy.s2Item3')}</li>
              <li>{t('usagePolicy.s2Item4')}</li>
              <li>{t('usagePolicy.s2Item5')}</li>
            </ul>
          </section>

          {/* Section 3: Professional Conduct & Anti-Discrimination (Highlighted) */}
          <section className="space-y-4 rounded-xl bg-indigo-50/60 border border-indigo-200/80 p-5">
            <h3 className="text-lg font-bold text-indigo-950 flex items-center gap-2">
              <span className="w-6 h-6 rounded-lg bg-indigo-200/80 text-indigo-900 flex items-center justify-center text-xs font-black">3</span>
              {t('usagePolicy.s3Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed font-medium">
              {t('usagePolicy.s3Intro')}
            </p>
            <p className="text-xs sm:text-sm text-slate-700 leading-relaxed">
              {t('usagePolicy.s3Body')}
            </p>
            <ul className="list-disc list-outside ml-6 space-y-2 text-xs sm:text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              ...
              {t('usagePolicy.s4Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              {t('usagePolicy.s4Body1')}
            </p>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              {t('usagePolicy.s4Body2')}
            </p>
          </section>
          ...
          <section className="space-y-3 border-t border-slate-100 pt-6">
            <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              ...
              {t('usagePolicy.s5Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              {t('usagePolicy.s5Body')}
            </p>
          </section>
        </div>
      </main>
