    ...
    <div className="min-h-[calc(100vh-80px)] bg-slate-950 text-white flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-6xl w-full">
          ...
          <div className="mt-6 inline-flex items-center p-1 bg-slate-900 border border-slate-800 rounded-2xl shadow-inner">
            ...
            >
              ...
              <span className={`text-[10px] font-extrabold uppercase px-2 py-0.5 rounded-full ${
                isAnnual ? 'bg-blue-900 text-amber-300' : 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30'
              }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-blue-950/90 to-slate-900 p-6 rounded-3xl border-2 border-blue-500 shadow-2xl relative flex flex-col justify-between">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-2.5 text-xs text-slate-200">
                ...
                <li className="flex items-center gap-2"><Check className="w-3.5 h-3.5 text-blue-400 shrink-0" /> <strong>{t('core.landing.pricing.pro.f2', 'All 17+ Advanced PDF Formats')}</strong></li>
                <li className="flex items-center gap-2"><Check className="w-3.5 h-3.5 text-blue-400 shrink-0" /> <strong>{t('core.landing.pricing.pro.f3', 'Custom Branding & Logos')}</strong></li>
                <li className="flex items-center gap-2"><Check className="w-3.5 h-3.5 text-blue-400 shrink-0" /> <strong>{t('core.landing.pricing.pro.f4', 'Client Portal & E-Signatures')}</strong></li>
                <li className="flex items-center gap-2"><Check className="w-3.5 h-3.5 text-blue-400 shrink-0" /> {t('core.landing.pricing.pro.f5', 'Unlimited Custom Rate Libraries')}</li>
              </ul>
            </div>
            ...
            {currentTier === 'pro' ? (
              <button
                type="button"
                disabled
                className="mt-6 w-full py-2.5 bg-blue-900/60 text-blue-300 text-xs font-bold rounded-xl border border-blue-700/60 cursor-not-allowed opacity-75"
              >
                {t('core.upgradeModal.currentPlanBadge', 'Current Plan')}
              </button>
            ) : (
