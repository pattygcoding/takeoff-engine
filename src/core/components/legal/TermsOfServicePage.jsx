        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs p-6 sm:p-10 space-y-8">
          ...
          <div className="border-b border-slate-200 dark:border-slate-800 pb-6">
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
              {t('core.termsOfService.effectiveDate', { date: 'September 18, 2026' })} • {t('core.termsOfService.subtitle')}
            </p>
          </div>
          ...
          <section className="space-y-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 p-5">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="w-6 h-6 rounded-lg bg-blue-600 text-white flex items-center justify-center text-xs font-black">3</span>
          ...
          <section className="space-y-3 rounded-xl bg-amber-50/60 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-800/60 p-5">
            <h3 className="text-lg font-bold text-amber-950 dark:text-amber-200 flex items-center gap-2">
              <span className="w-6 h-6 rounded-lg bg-amber-200/80 dark:bg-amber-900/60 text-amber-900 dark:text-amber-300 flex items-center justify-center text-xs font-black">7</span>
              {t('core.termsOfService.s7Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed font-medium">
              {t('core.termsOfService.s7Body')}
            </p>
          </section>
          ...
          <section className="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="w-6 h-6 rounded-lg bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xs font-black">8</span>
              {t('core.termsOfService.s8Title')}
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              {t('core.termsOfService.s8Body')}
            </p>
            <div className="pt-2">
              <a
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="w-6 h-6 rounded-lg bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xs font-black">9</span>
