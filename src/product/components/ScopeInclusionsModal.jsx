...
import { Check, X, Save, RotateCcw, Info, Bath, Truck, ClipboardList, Package, Trash2, Scale } from 'lucide-react';
import {
  SCOPE_STATUS,
  DEFAULT_SCOPE_ITEMS,
...
export default function ScopeInclusionsModal({
  ...
  const metricsBadges = (
    <div className="flex flex-wrap items-center gap-1.5 text-xs">
      <span className="px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 font-bold border border-emerald-200 dark:border-emerald-800 inline-flex items-center gap-1">
        <Check className="w-3 h-3" /> {includedCount} {t('product.scopeModal.included', 'Included')}
      </span>
      <span className="px-2.5 py-1 rounded-full bg-rose-50 dark:bg-rose-950/50 text-rose-700 dark:text-rose-300 font-bold border border-rose-200 dark:border-rose-800 inline-flex items-center gap-1">
    ...
    <>
      ...
      {!readOnly && (
          <div className="py-2.5 px-3.5 my-2.5 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200/80 dark:border-slate-800 flex flex-wrap items-center justify-between gap-2.5 text-xs">
            <div className="flex flex-wrap items-center gap-2">
              <span className="font-bold text-slate-600 dark:text-slate-300 flex items-center gap-1">
                <Save className="w-3.5 h-3.5" /> {t('product.scopeModal.presetsLabel', 'Presets')}:
              </span>
              <select
              ...
              {selectedPresetId && (
                ...
                >
                  <X className="w-3 h-3 inline mr-1 -mt-0.5" />{t('core.common.delete')}
                </button>
              )}
              ...
              >
                <RotateCcw className="w-3 h-3 inline mr-1 -mt-0.5" />{t('product.scopeModal.btnResetDefault', 'Reset Defaults')}
              </button>
            </div>
            ...
            <div className="flex items-center gap-2">
              {!showSavePresetInput ? (
                ...
                <form onSubmit={handleSavePreset} className="flex items-center gap-1.5">
                  ...
                  >
                    <Check className="w-3 h-3 inline mr-1 -mt-0.5" />{t('core.common.save')}
                  </button>
                  <button
                    type="button"
                    onClick={() => {
        ...
        <div className="pt-1 pb-2 flex flex-wrap items-center gap-1.5 text-xs font-semibold">
          ...
          >
            <Bath className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.scopeModal.catFixtures', 'Fixtures (Toilets, Sinks, Faucets)')}
          </button>
          <button
            type="button"
          ...
          >
            <Truck className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.scopeModal.catSite', 'Site & Trench Earthwork')}
          </button>
          <button
            type="button"
          ...
          >
            <ClipboardList className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.scopeModal.catAdmin', 'Permits & Testing')}
          </button>
          <button
            type="button"
          ...
          >
            <Package className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.scopeModal.catMisc', 'Miscellaneous & Other')}
          </button>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-1 shrink-0 self-end sm:self-center">
                  ...
                  >
                    <Check className="w-3 h-3 inline mr-1 -mt-0.5" />{t('product.scopeModal.btnIncluded', 'Include')}
                  </button>
                  ...
                  >
                    <X className="w-3 h-3 inline mr-1 -mt-0.5" />{t('product.scopeModal.btnExcluded', 'Exclude')}
                  </button>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-9 h-9 rounded-2xl bg-amber-100 dark:bg-amber-950/80 text-amber-800 dark:text-amber-300 flex items-center justify-center shrink-0 border border-amber-300 dark:border-amber-700">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl max-w-4xl w-full p-5 sm:p-7 border border-slate-200 dark:border-slate-800 max-h-[92vh] flex flex-col my-auto text-slate-900 dark:text-slate-100">
        ...
        <div className="pb-4 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-amber-100 dark:bg-amber-950/80 text-amber-800 dark:text-amber-300 flex items-center justify-center shrink-0 border border-amber-300 dark:border-amber-700">
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-xs animate-fade-in">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-sm w-full p-6 border border-slate-200 dark:border-slate-800 text-center">
        <div className="w-14 h-14 mx-auto rounded-full bg-emerald-100 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center border border-emerald-300 dark:border-emerald-700">
