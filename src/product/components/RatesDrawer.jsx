...
import { Settings, Globe, Library, HardHat, Truck, Ruler, Coins, Check, X, Trash2, Users } from 'lucide-react';
        ...
        <div className="shrink-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 z-10">
          <div className="flex items-center justify-between p-4 sm:p-5 pb-3">
            <div className="flex items-center gap-2">
              <span className="text-xl"><Settings className="w-5 h-5" /></span>
              <div>
          ...
          <div className="px-4 sm:px-5 pb-3 flex flex-wrap items-center gap-1.5">
            ...
            >
              <Globe className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.ratesDrawer.sectionAll', 'All Settings')}
            </button>
            <button
              type="button"
            ...
            >
              <Library className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.ratesDrawer.sectionTemplates', 'Templates')}
            </button>
            <button
              type="button"
            ...
            >
              <HardHat className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.ratesDrawer.sectionLabor', 'Labor & Crew')}
            </button>
            <button
              type="button"
            ...
            >
              <Truck className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.ratesDrawer.sectionEquipment', 'Equipment')}
            </button>
            <button
              type="button"
            ...
            >
              <Ruler className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.ratesDrawer.sectionTrenching', 'Trenching')}
            </button>
            <button
              type="button"
            ...
            >
              <Coins className="w-3.5 h-3.5 inline mr-1 -mt-0.5" />{t('product.ratesDrawer.sectionMarkups', 'Markups & Misc')}
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-6">
          ...
          {(activeSection === 'all' || activeSection === 'templates') && (
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-50/90 via-blue-50/40 to-slate-50 dark:from-blue-950/40 dark:via-slate-800/80 dark:to-slate-800/60 border-2 border-blue-200/80 dark:border-blue-800/80 rounded-2xl p-4 shadow-xs">
              ...
              {successMsg && (
                <div className="mb-3 p-2 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-300 text-xs rounded-lg font-medium flex items-center gap-1.5">
            ...
            <section className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-2xl p-4">
              ...
              <div className="mt-3 space-y-2.5">
                {equipmentCatalog.map((eq) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      <span className="text-sm"><Truck className="w-4 h-4" /></span>
                      <input
                        type="text"
                        value={eq.title}
                        disabled={readOnly}
        ...
        {showSaveModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 max-w-sm w-full p-5 text-slate-900 dark:text-slate-100">
              ...
              {errorMsg && (
                <div className="mb-3 p-2 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-900 text-red-700 dark:text-red-300 text-xs rounded-lg flex items-center gap-1.5">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 max-w-md w-full p-5 text-slate-900 dark:text-slate-100 animate-in fade-in zoom-in-95 duration-150">
              <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                <div className="flex items-center gap-2">
                  <span className="text-xl"><Users className="w-5 h-5" /></span>
                  <div>
